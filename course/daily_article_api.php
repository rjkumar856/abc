...
if($_SERVER['REQUEST_METHOD'] == "POST"){
		try{
		    ...
		    $query = "SELECT * FROM daily_article";
			...
			for($i = 0;  $object = $stmt->fetch(PDO::FETCH_ASSOC); $i++){
				$json['items'][] = array("id"=>$object['id'],"date"=>$object['date'],"title"=>htmlentities($object['title']),
				"file_links"=>DIR_SYSTEM.'assets/files/article/'.$object['file_links'],
				"file_urls"=>$object['file_url'],
