...
if($_SERVER['REQUEST_METHOD'] == "POST"){
		try{
		    ...
		    $query = "SELECT DISTINCT subject FROM study_materials ORDER BY subject ASC";
			...
			for($i = 0;  $object = $stmt->fetch(PDO::FETCH_ASSOC); $i++){
			    ...
			    $sql_result = "SELECT * FROM study_materials WHERE subject='$object[subject]' ORDER BY title ASC";
